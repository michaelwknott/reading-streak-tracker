# apps/calendar/script.py
"""
Note (2023-10-01 10:01):
This is the original script file from the PDM code clinic.
So far it was left largely as-is. We make use of it in `views.py`.
"""
import calendar
