...
def tailwind_message_tag(message_tag):
    ...
    """
    classes = {
        "debug": "debug bg-gray-100 border border-gray-500 text-gray-700 px-4 py-3 rounded relative",
        "info": "info bg-blue-100 border border-blue-500 text-blue-700 px-4 py-3 rounded relative",
        "success": "success bg-green-100 border border-green-500 text-green-700 px-4 py-3 rounded relative",
        "warning": "warning bg-yellow-100 border border-yellow-500 text-yellow-700 px-4 py-3 rounded relative",
        "error": "error bg-red-100 border border-red-500 text-red-700 px-4 py-3 rounded relative",
    }
